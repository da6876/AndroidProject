...
public class PhoneNumberVerify extends AppCompatActivity {
    ...
    TextInputEditText edt_phone_number,edt_countryCode;
   // private CountryCodePicker ccp;
    String countyCode="", phone="";
    @Override
        ...
        edt_phone_number.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                if (!isInternetAvailable()){
                    alertDialog(PhoneNumberVerify.this,"Message","No Internet Connection");
                }else {
    ...
    private void sendVarificationCode(){
         ...
         //countyCode = edt_countryCode.getText().toString();

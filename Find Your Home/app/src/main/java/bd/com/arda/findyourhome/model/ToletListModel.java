...
public class ToletListModel implements Serializable {
    ...
    private String TOLET_INFO_ID, USER_ACC_ID, TOLET_NAME, TOLET_DETAILS, ADDRESS,
            ...
            TOLET_TYPE_NAME, PRODUCT_IMAGE, CREATE_DATA, CREATE_BY;

    public ToletListModel(String TOLET_INFO_ID, String USER_ACC_ID, String TOLET_NAME, String TOLET_DETAILS, String ADDRESS,
                          ...
                          String TOLET_TYPE_ID, String TOLET_TYPE_NAME,String PRODUCT_IMAGE, String CREATE_DATA, String CREATE_BY) {
